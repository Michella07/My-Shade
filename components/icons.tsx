...
export const HeartIcon: React.FC<IconProps & { filled?: boolean }> = ({ className = "w-6 h-6", filled }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill={filled ? 'currentColor' : 'none'} strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const CrownIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.362 5.214A8.252 8.252 0 0112 21 8.25 8.25 0 018.638 5.214m8.112-2.948a3 3 0 00-5.498 0M15 9.75a3 3 0 11-6 0 3 3 0 016 0z" />
    </svg>
);
...
export const SupportIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a6 6 0 006-6v-1.5a6 6 0 00-6-6.75v-1.5m-6 16.5v-1.5a6 6 0 016-6v-1.5a6 6 0 01-6-6.75v-1.5m6 16.5a6 6 0 00-6-6v-1.5a6 6 0 006-6.75v-1.5m6 16.5v-1.5a6 6 0 01-6-6v-1.5a6 6 0 016-6.75v-1.5m-6 16.5l-3-3m3 3l3-3m-3-12l-3 3m3-3l3 3" />
    </svg>
);

export const MakeupArtistIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z" />
    </svg>
);

export const PartnershipIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 10.125v1.875" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.362 5.214A8.252 8.252 0 0112 21 8.25 8.25 0 018.638 5.214m8.112-2.948a3 3 0 00-5.498 0M15 9.75a3 3 0 11-6 0 3 3 0 016 0z" />
    </svg>
);
...
export const SettingsIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.007 1.11-.992l2.173.121c.53.03.987.472 1.005.992l.023.53a1.8 1.8 0 01-.39 1.185l-1.345 1.345a1.8 1.8 0 01-1.185.39l-.53.023c-.52.018-1.06-.432-.992-1.11l.121-2.173z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M19.07 4.93a10.41 10.41 0 010 14.14 10.41 10.41 0 01-14.14 0A10.41 10.41 0 014.93 4.93a10.41 10.41 0 0114.14 0z" />
    </svg>
);
...
export const FaceIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
